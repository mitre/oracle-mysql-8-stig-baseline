...
If these results do not meet password complexity requirements listed above, this is a finding.)
  desc 'fix', "If the use of passwords is not needed, configure the MySQL Database Server 8.0 to prevent their use if it is capable of this; if it is not, institute policies and procedures to prohibit their use.
...
ALTER USER 'jeffrey'@'localhost' PASSWORD EXPIRE INTERVAL 90 DAY;"
  ...
  tag gid: 'V-235137'
  tag rid: 'SV-235137r998288_rule'
  tag stig_id: 'MYS8-00-005000'
  tag fix_id: 'F-38319r998287_fix'
