...
organization-defined information system components.'
  desc 'Database Management Systems (DBMSs) handling data requiring "data at
...
media on which the information resides.'
  desc 'check', %q(Review the system documentation to determine whether the organization has
...
is a finding.)
  desc 'fix', "Configure the MySQL Database Server 8.0, operating system/file system, and
