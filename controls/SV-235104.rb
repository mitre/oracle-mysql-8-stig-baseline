...
lightly."
  desc 'check', "Check MySQL settings and documentation to determine whether designated
...
is a finding."
  desc 'fix', "Configure the MySQL Database Server 8.0 settings to allow designated
