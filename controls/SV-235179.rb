...
REVOKE role [, role ] ...
  ...
  mysql_administrative_grantees = if !input('aws_rds')
                                    input('mysql_administrative_grantees')
                                  else
                                    input('mysql_administrative_grantees') + ["'rdsadmin'@'localhost'"]
                                  end
