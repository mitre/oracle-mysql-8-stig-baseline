...
infrastructure must leverage transmission protection mechanisms.'
  desc 'check', 'If the data owner does not have a strict requirement for ensuring data
...
a finding.'
  desc 'fix', 'Turn on require_secure_transport. In this mode the server permits only
