control 'SV-235187' do
  title "The MySQL Database Server 8.0 must use #{input('org_name')}-approved cryptography to
...
policies, regulations, and standards.
    ...
    #{input('org_name')}-approved cryptography for classified networks is hardware based. This
...
running this command:
  ...
  "
  desc 'fix', "
    Configure cryptographic functions to use #{input('org_name')}-approved
