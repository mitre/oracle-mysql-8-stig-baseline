...
If the audit event is not present, this is a finding.)
  desc 'fix', 'If currently required, configure the MySQL Database Server with stored
...
well as providing the details for the audit event.
  ...
  sql_session.query(query_server_audit_events)
